var  itemMostrado=[], ciudad_f, tipos_f;
...
function datos(){
    $.ajax({
          ...
          success:  function (response) {
            ...
            //si se presiona mostrarTodos antes de hacer consulta se nuestre todo el contenido
            for(i=0; i<100;i++){
